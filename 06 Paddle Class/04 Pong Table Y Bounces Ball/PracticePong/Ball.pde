...
class Ball
{
  ...
  //
  //Getters and Setter
  void tableYUpdate( float tableXParameter, float tableYParameter, float tableWidthParameter, float tableHeightParameter ) {
    //Note: these variables will never change
    tableX = tableXParameter;
    tableY = tableYParameter;
    tableWidth = tableWidthParameter;
